...
[Accept-Ranges HTTP header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Accept-Ranges)

[Content-Range](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Range)

[HTTP 206 status](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/206)
